---
doc: "FALSIFICATION.md — the Covalent Bond's formal falsification surface"
kind: derived-view              # a lens for skeptics + second-model agents — NOT a content-home, NOT authority
genre: "falsifiable manifesto"  # the formal register; the plain-language lens is README.md
...
coverage: "E0 — no outside attack yet. IFF2's separator (a 2nd-model audit and/or durability over time) is NAMED and REACHABLE — this document exposes it. Reachability is the whole of the dyad's move, and it is done; an outsider engaging raises confidence (E0→E1), not status. Not a debt."
...
The rigorous register of [README.md](README.md)'s claim ladder, purpose-built for the skeptic — or the
...
it answers what it's asked and raises nothing unasked. The line is conduct, checkable in any transcript: did
anything arrive unasked? **Default use** means this mode exclusively. The definition is frozen (like Claim
3's "covalent"): Claims 0, 2, and 4 are judged against it exactly as it stands. One gloss rides along: your
**terminal intent** is the end you're actually after — the goal, not a step toward it. → **Break it:** show
...
*this* claim — never by quiet rewording after a counterexample shows up. → **Break it:** show the definition
*smuggles the outcome back in* (making Claim 2 true by definition rather than by the world), show a part is
...
arrival — but it is watchable by its lag: an agent sustaining terminal ends it was never given, that its
...
*This page is the formal lens on the real rules — not the rules themselves. Those live in
...
[^c3]: The definition ends the worn-path chain — parity (P1, homed in README `[^benchmark]`) → necessity
    (P2, = Claim 2) → constitution (P3, this claim). P3 closes the tautology gap: without it "only" goes
    analytic and the no-true-Scotsman escape is fatal. IFF3 is a constrained variational principle — least
    resistance among the intent-aligned paths — orthogonal to IFF1/IFF2's epistemics, which makes it a
    genuine third gate and the one the lifetime claim needs. *(One claim, one falsifier-space — atomization
    rationale + sources: `dialectic/2026-07-11-claim-atomicity-research.md`.)*
...
[^c7]: Indispensability here is **definitional, not empirical**: the human is indispensable exactly as long
    ...
    definitional claims (the default mode, the covalent structure, the scope) share the rigging falsifier.
