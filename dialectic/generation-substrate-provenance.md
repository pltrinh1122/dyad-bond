...
> **Provenance record.** This file documents the questions asked, falsifications, and reasoning that shaped the generation-distillations mechanism. Not operational (see `generation-distillations.md` for that); kept for understanding *why* the mechanism is the way it is. Important for future G that needs to understand the design decisions.
...
- A commits to generation-distillations.md
