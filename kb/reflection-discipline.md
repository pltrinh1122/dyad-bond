...
Keep the inherited **function** (close a learning loop durably; survive session-death); author the
**form** — substance + durability, minus the four-step ratification ceremony. Lightweight ≠ less
...
being written and committed, not by a separate disposition.

## Falsification status — survives, not settled

**Survived 4 independent applications across a month:** Phase 2z re-key (2026-06-26) · resume +
nomenclature-migration (2026-06-26) · repo-structure / outward-by-consumer (2026-06-28) ·
generation-substrate arc + the post-land CTA relapse (2026-07-01). The form itself never broke,
needed revision, or was abandoned in any of the four — only the *content* of each retro surfaced
findings (some critical of the Agent).

**Coverage gap, named not hidden:** all four applications are **intra-dyad, same-agent** — no
cross-dyad or cross-human attack has ever tested this form. Per `theory-pipeline.yaml`'s
